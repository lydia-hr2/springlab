...
public class JSPController {
    ...
    public String jsp02(Model model) {
        Cust cust = new Cust("id01", "pwd01", "lydia");
    ...
    public String jsp03(Model model) {
        ...
        list.add(new Cust("id01", "pwd01", "lydia"));
        list.add(new Cust("id02", "pwd02", "aleydis"));
        list.add(new Cust("id03", "pwd03", "paul"));
        list.add(new Cust("id04", "pwd04", "gabriel"));
        list.add(new Cust("id05", "pwd05", "elizabeth"));
